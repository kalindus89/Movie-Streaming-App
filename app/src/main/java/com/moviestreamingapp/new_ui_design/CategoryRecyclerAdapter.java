...
public class CategoryRecyclerAdapter extends RecyclerView.Adapter<CategoryRecyclerAdapter.MainViewHolder> {
    ...
    public CategoryRecyclerAdapter(Context context, List<AllMovieCategories> allMovieCategoriesList) {
    ...
    @NonNull
    @Override
    public CategoryRecyclerAdapter.MainViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return  new MainViewHolder(LayoutInflater.from(context).inflate(R.layout.item_main_recycler_row,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull CategoryRecyclerAdapter.MainViewHolder holder, int position) {
